...
export class ApiStack extends Stack {
    constructor(scope: Construct, id: string, props: ApiStackProps) {
        ...
        spacesResource.addMethod('GET', props?.lambdaFunction);// if we want a post request as well then we can have another line with but inplace of get it will be post and in that case 2 path will be pointing to same lambda
    }
}